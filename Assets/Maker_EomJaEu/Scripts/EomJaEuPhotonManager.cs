...
public class EomJaEuPhotonManager : MonoBehaviourPunCallbacks
{
    [Header("리스폰 장소 그룹")]
    ...
    public IEnumerator SpwanPlayer()
    {
        ...
        PhotonNetwork.Instantiate("EomJaEuCharacter", points[index].transform.position, points[index].transform.rotation, 0);
    }
}
